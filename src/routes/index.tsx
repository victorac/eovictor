...
function App() {
  return (
    <div className="px-8 py-2 flex flex-col bg-[#1c1b1f] h-screen w-full">
...
usability, and data visualization.`,
      ...
      <div className="flex flex-col px-8">
        ...
        <span className="font-bold text-neutral-50 mb-2">Education</span>
      ...
      <div className="flex justify-end gap-12">
        <span className="font-extrabold text-neutral-50">+55 11 72008362</span>
        ...
        <a href="https://github.com/victorac" target="_blank">
          <span className="font-extrabold text-neutral-50">
            <span className="font-normal neutral-300/78">GitHub:</span> victorac
          </span>
        </a>
        <span className="font-extrabold text-neutral-50">
          hello@eovictor.com
...
function Card({ title, period, company, sections, active }: CardProps) {
  return (
    <div
      className={`flex flex-col max-w-[300px] rounded-sm p-4 ${active ? 'shadow-2xl bg-[#16151a]' : ''}`}
    >
...
function SelectedProjects() {
  return (
    <div className="bg-[#16151a] flex flex-col max-w-[300px] shadow-2xl rounded-sm p-4 gap-4">
